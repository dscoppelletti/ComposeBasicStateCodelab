...
//        /* END-5.3 */
        if (count > 0) {
            /* BEGIN-7 - Remember in Composition */
            // remember stores objects in the Composition, and forgets the
            // object if the source location where remember is called is not
            // invoked again during a recomposition.
